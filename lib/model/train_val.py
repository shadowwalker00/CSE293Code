  ...
  def train_model(self, sess, max_iters):
    ...
    while iter < max_iters + 1:
      ...
      if iter % (cfg.TRAIN.DISPLAY) == 0:
        print("iter:{}/{},total loss:{:.4f},rpn_loss_cls:{:.4f},rpn_loss_box:{:.4f},loss_cls:{:.4f},loss_box:{:.4f},lr:{:.4f},speed:{:.4f}"\
          .format(iter, max_iters, total_loss, rpn_loss_cls, rpn_loss_box, loss_cls, loss_box, lr.eval(),timer.average_time))
